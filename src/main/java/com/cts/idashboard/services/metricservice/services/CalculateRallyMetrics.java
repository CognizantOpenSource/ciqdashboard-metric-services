...
import com.cts.idashboard.services.metricservice.data.SourceRallyData;
...
@Component
public class CalculateRallyMetrics {
    ...
    public MetricResults calculateRallyMetrics(String metricName, ProjectMetric projectMetric,String SourceRallyData) throws Exception {
        ...
        if(projectMetric.getCustomFunction().equalsIgnoreCase("Yes")) {
            ...
            projectMetric = customFunctions.executeCustomFunction(projectMetric, "SourceRallyData");
        }
            ...
            projectMetric = trendDateFormatter.trendDateFormatMethod(metricName,projectMetric,SourceRallyData);
        }
            ...
            if (!(projectMetric.getGroupValue().equalsIgnoreCase("All"))) {
                ...
                distinctData =mongoOperation.findDistinct(projectMetric.getGroupBy(), SourceRallyData.class, String.class);
            }
            ...
            for (Map.Entry<String, JSONObject> map : formulaParams.entrySet()) {
                ...
                for (Map.Entry<String, JSONObject> valObj : valueObjectMap.entrySet()) {
                    ...
                    if (valObj.getKey().equals("count")) {
                        Long valKey = metricFunctions.count("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), Double.valueOf(valKey));
                    } else if (valObj.getKey().equals("countAnd")) {
                        Long valKey = metricFunctions.countAnd("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), Double.valueOf(valKey));
                    } else if (valObj.getKey().equals("sum")) {
                        Double valKey = metricFunctions.sum("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumAnd")) {
                        Double valKey = metricFunctions.sumAnd("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("avg")) {
                        Double valKey = metricFunctions.avg("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("avgAnd")) {
                        Double valKey = metricFunctions.avgAnd("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISO")) {
                        Double valKey = metricFunctions.sumIS0("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISOAnd")) {
                        Double valKey = metricFunctions.sumIS0And("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISODiff")) {
                        Double valKey = metricFunctions.sumIS0Diff("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISODiffAnd")) {
                        Double valKey = metricFunctions.sumIS0DiffAnd("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("max")) {
                        Long valKey = metricFunctions.max("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("maxAnd")) {
                        Long valKey = metricFunctions.maxAnd("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("min")) {
                        Long valKey = metricFunctions.min("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("minAnd")) {
                        Long valKey = metricFunctions.minAnd("SourceRallyData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else{
    ...
    public MetricResults saveMetricResult(String metricName, int metricValue, ProjectMetric projectMetric) {
        ...
        if (metricResults.isPresent()) {
            ...
            metricResult.setToolType("Rally");
