...
import com.cts.idashboard.services.metricservice.data.SourceZephyrScaleData;
...
@Component
public class CalculateZephyrScaleMetrics {
    ...
    public MetricResults  calculateZephyrScaleMetrics(String metricName, ProjectMetric projectMetric, String SourceZephyrScaleData) throws Exception {
        ...
        if(projectMetric.getCustomFunction()!=null && projectMetric.getCustomFunction().equalsIgnoreCase("Yes")) {
            ...
            projectMetric = customFunctions.executeCustomFunction(projectMetric, SourceZephyrScaleData);
        }
            ...
            projectMetric = trendDateFormatter.trendDateFormatMethod(metricName,projectMetric,SourceZephyrScaleData);
        }
            ...
            if (!(projectMetric.getGroupValue().equalsIgnoreCase("All"))) {
                ...
                distinctData =mongoOperation.findDistinct(projectMetric.getGroupBy(), SourceZephyrScaleData.class, String.class);
            }
    ...
    public int calculateMetricValue(String metricName, String distinctValue, ProjectMetric projectMetric) throws Exception {
            ...
            for (Map.Entry<String, JSONObject> map : formulaParams.entrySet()) {
                ...
                for (Map.Entry<String, JSONObject> valObj : valueObjectMap.entrySet()) {
                    ...
                    if (valObj.getKey().equals("count")) {
                        Long valKey = metricFunctions.count("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), Double.valueOf(valKey));
                    } else if (valObj.getKey().equals("countAnd")) {
                        Long valKey = metricFunctions.countAnd("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), Double.valueOf(valKey));
                    } else if (valObj.getKey().equals("sum")) {
                        Double valKey = metricFunctions.sum("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumAnd")) {
                        Double valKey = metricFunctions.sumAnd("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("avg")) {
                        Double valKey = metricFunctions.avg("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("avgAnd")) {
                        Double valKey = metricFunctions.avgAnd("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISO")) {
                        Double valKey = metricFunctions.sumIS0("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISOAnd")) {
                        Double valKey = metricFunctions.sumIS0And("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISODiff")) {
                        Double valKey = metricFunctions.sumIS0Diff("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISODiffAnd")) {
                        Double valKey = metricFunctions.sumIS0DiffAnd("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("max")) {
                        Long valKey = metricFunctions.max("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("maxAnd")) {
                        Long valKey = metricFunctions.maxAnd("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("min")) {
                        Long valKey = metricFunctions.min("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("minAnd")) {
                        Long valKey = metricFunctions.minAnd("SourceZephyrScaleData", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else{
        ...
        System.out.println("Formula value : " + result);
    ...
    public MetricResults saveMetricResult(String metricName, int metricValue, ProjectMetric projectMetric) {
        ...
        if (metricResults.isPresent()) {
            ...
            metricResult.setToolType("ZephyrScale");
