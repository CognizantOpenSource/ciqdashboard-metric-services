...
import com.cts.idashboard.services.metricservice.repos.MetricsRepository;
...
@Service
public class CalculateALMMetric {
    ...
    public MetricResults calculateALMMetric(String metricName, ProjectMetric projectMetric, String SourceAlmAssets) throws Exception {
        ...
        if(projectMetric.getCustomFunction().equalsIgnoreCase("Yes")) {
            ...
            projectMetric = customFunctions.executeCustomFunction(projectMetric, "SourceAlmAssets");
        }
            ...
            projectMetric = trendDateFormatter.trendDateFormatMethod(metricName,projectMetric,SourceAlmAssets);
        }
            ...
            if (!(projectMetric.getGroupValue().equalsIgnoreCase("All"))) {
                ...
                distinctData =mongoOperation.findDistinct(projectMetric.getGroupBy(), SourceAlmAssets.class, String.class);
            }
            ...
            for (Map.Entry<String, JSONObject> map : formulaParams.entrySet()) {
                ...
                for (Map.Entry<String, JSONObject> valObj : valueObjectMap.entrySet()) {
                    ...
                    if (valObj.getKey().equals("count")) {
                        Long valKey = metricFunctions.count("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), Double.valueOf(valKey));
                    } else if (valObj.getKey().equals("countAnd")) {
                        Long valKey = metricFunctions.countAnd("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), Double.valueOf(valKey));
                    } else if (valObj.getKey().equals("sum")) {
                        Double valKey = metricFunctions.sum("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumAnd")) {
                        Double valKey = metricFunctions.sumAnd("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("avg")) {
                        Double valKey = metricFunctions.avg("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("avgAnd")) {
                        Double valKey = metricFunctions.avgAnd("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISO")) {
                        Double valKey = metricFunctions.sumIS0("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISOAnd")) {
                        Double valKey = metricFunctions.sumIS0And("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISODiff")) {
                        Double valKey = metricFunctions.sumIS0Diff("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        System.out.println("sumISODiff value : " + valKey);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("sumISODiffAnd")) {
                        Double valKey = metricFunctions.sumIS0DiffAnd("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey);
                    } else if (valObj.getKey().equals("max")) {
                        Long valKey = metricFunctions.max("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("maxAnd")) {
                        Long valKey = metricFunctions.maxAnd("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("min")) {
                        Long valKey = metricFunctions.min("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else if (valObj.getKey().equals("minAnd")) {
                        Long valKey = metricFunctions.minAnd("SourceAlmAssets", valueMap.entrySet(), projectMetric, "No", isGrouping, null, null, distinctValue);
                        variableSet.set(map.getKey(), valKey.doubleValue());
                    } else {
